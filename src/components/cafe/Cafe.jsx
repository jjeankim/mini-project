...
const Cafe = ({ cafe }) => {
  ...
  return (
    <div onClick={handleClickCard} className="w-[250px] max-h-[500px] text-center border-[1px] p-[20px] rounded-lg">
      <img
      ...
      <p className="text-xs text-gray-300 mb-[8px]">{getTagList(cafe.CON_KEYWORDS)}</p>
    </div>
  );
};
